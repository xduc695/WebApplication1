...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.AttendanceSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.ClassSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.CourseResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.CourseResourceFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.Enrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.Assignment", b =>
                {
                    b.HasOne("ClassMate.Api.Entities.ClassSection", "ClassSection")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.HasOne("ClassMate.Api.Entities.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.ClassSection", b =>
                {
                    b.HasOne("ClassMate.Api.Entities.Course", "Course")
                        .WithMany("ClassSections")
                        .HasForeignKey("CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ClassMate.Api.Entities.AppUser", "Teacher")
                        .WithMany()
            ...
            modelBuilder.Entity("ClassMate.Api.Entities.CourseResourceFile", b =>
                {
                    b.HasOne("ClassMate.Api.Entities.CourseResource", "CourseResource")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ClassMate.Api.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
